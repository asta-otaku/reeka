  ...
  return (
    <div className="bg-[#FAFAFA]">
      ...
      >
        ...
        <main className="bg-white md:ml-[232px] lg:ml-[312px] md:max-w-[calc(100vw-312px)] min-h-screen md:min-h-[100vh-48px] border shadow-sm shadow-gray-300 rounded-xl grow overflow-x-auto">
          {children}
        </main>
      </div>
    </div>
